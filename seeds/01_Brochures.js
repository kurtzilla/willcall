...
exports.seed = function(knex, Promise) {
  // Deletes ALL existing entries
    ...
    return Promise.all([
      ...
      knex('brochures').insert({id: 1, title: 'Tickets - your terms', abstract: 'Avoid exorbitant hidden fees. Show your customers the <strong>ONE</strong> price they need to know. Simply include your service fees in an all-in pricing structure.', description: ''}),
      ...
      knex('brochures').insert({id: 5, title: 'Administrative console',
